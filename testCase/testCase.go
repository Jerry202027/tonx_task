...
func InsertSampleFlights() error {
	...
	sampleFlights := []model.Flight{
		...
		},
		{
			...
			Origin:               "TPE",
			Destination:          "LAX",
			FlightDate:           time.Date(2025, 3, 6, 0, 0, 0, 0, time.UTC),
			DepartureTime:        time.Date(2025, 3, 6, 23, 40, 0, 0, time.UTC),
			ArrivalTime:          time.Date(2025, 3, 7, 17, 40, 0, 0, time.UTC),
			Price:                1080.0,
			Capacity:             330,
			OverbookingThreshold: 9,
		},
		{
			FlightNo:             "BR118",
			Origin:               "TPE",
			Destination:          "HND",
			FlightDate:           time.Date(2025, 3, 8, 0, 0, 0, 0, time.UTC),
			DepartureTime:        time.Date(2025, 3, 8, 8, 20, 0, 0, time.UTC),
			ArrivalTime:          time.Date(2025, 3, 8, 12, 20, 0, 0, time.UTC),
			Price:                350.0,
			Capacity:             200,
			OverbookingThreshold: 6,
		},
		{
			...
			Origin:               "TPE",
			Destination:          "KIX",
			FlightDate:           time.Date(2025, 3, 9, 0, 0, 0, 0, time.UTC),
			DepartureTime:        time.Date(2025, 3, 9, 10, 30, 0, 0, time.UTC),
			ArrivalTime:          time.Date(2025, 3, 9, 13, 45, 0, 0, time.UTC),
			Price:                275.0,
			Capacity:             180,
			OverbookingThreshold: 3,
		},
		{
			...
			Origin:               "TPE",
			Destination:          "SFO",
			FlightDate:           time.Date(2025, 3, 10, 0, 0, 0, 0, time.UTC),
			DepartureTime:        time.Date(2025, 3, 10, 22, 0, 0, 0, time.UTC),
			ArrivalTime:          time.Date(2025, 3, 11, 15, 0, 0, 0, time.UTC),
			Price:                1250.0,
			Capacity:             280,
			OverbookingThreshold: 5,
		},
